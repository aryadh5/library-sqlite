...
public class ShowBooksActivity extends AppCompatActivity {
    ...
    BookAdapter customeadapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show_books);
        recyclerView = findViewById(R.id.recycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(ShowBooksActivity.this));
        database = new DatabaseHelper(ShowBooksActivity.this);
        ...
        saveBooksData();
        customeadapter = new BookAdapter(this,book_id,book_title,book_author,book_pages,book_des);
